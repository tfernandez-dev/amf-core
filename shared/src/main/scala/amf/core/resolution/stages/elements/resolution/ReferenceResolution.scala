...
class ReferenceResolution(errorHandler: ErrorHandler,
  ...
  private def traverseNestedLinksIfCopy(element: DomainElement, conditions: Seq[Condition], l: DomainElement with Linkable, resolved: DomainElement) = {
  ...
  private def shouldCopyElement(conditions: Seq[Condition], linkable: Linkable, linkableAsElement: DomainElement): Boolean = {
